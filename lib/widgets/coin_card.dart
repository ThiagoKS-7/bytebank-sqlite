  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
          ...
          color: appBgColorSecondary.withOpacity(0.4),
          boxShadow: [
            BoxShadow(
          ...
          children: [
            Row(
              children: [
                ...
                SizedBox(width: 5,),
                Expanded(child: Text(cardData["name"], maxLines: 1, overflow: TextOverflow.fade, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600),)),
              ],
            ),
            SizedBox(height: 15,),
            Row(
